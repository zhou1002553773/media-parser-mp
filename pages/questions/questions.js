...
Page({
  data: {
    ...
    questions: [
      ...
      { id: 8, category: '功能', question: '在哪里能看到已经下载/解析过的视频？', answer: '打开优创猫首页，点击底部「我的」进入个人中心，在「我的解析记录」里就能看到所有解析、下载过的视频，还能按时间排序查找。', showAnswer: false },
      ...
      { id: 11, category: '技术', question: '小程序运行卡顿、界面错乱，怎么解决？', answer: '简单2步就能修复：① 关闭优创猫小程序（在微信「最近使用的小程序」里删掉）；② 重新打开优创猫，大部分卡顿/错乱问题都会解决。如果还不行，建议重启微信再试。', showAnswer: false },
